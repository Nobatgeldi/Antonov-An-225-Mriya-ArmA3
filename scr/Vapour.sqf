...
while {(alive _plane)} do
{
	...
	{		
		...
		_particle = drop ["\wop_gui\data\cl_basic", "", "Billboard", 1, 25, (_plane selectionposition "osa vrtule"), [0,0,0],    0, 0.0052, 0.0040, 0.1, [1, 15, 30], [[0.5,0.5,0.5,0.0],[0.5,0.5,0.5,0.2],[0.5,0.5,0.5,0.1],[0.5,0.5,0.5,0.05],[0.5,0.5,0.5,0.025],[0.5,0.5,0.5,0.012],[0.5,0.5,0.5,0.0]],[0],0.0,2.0, "", "", _plane];
		...
		_particle = drop ["\wop_gui\data\cl_basic", "", "Billboard", 1, 25, (_plane selectionposition "osa vrtule 3"), [0,0,0],   	0, 0.0052, 0.0040, 0.1, [1, 15, 30], [[0.5,0.5,0.5,0.0],[0.5,0.5,0.5,0.2],[0.5,0.5,0.5,0.1],[0.5,0.5,0.5,0.05],[0.5,0.5,0.5,0.025],[0.5,0.5,0.5,0.012],[0.5,0.5,0.5,0.0]],[0],0.0,2.0, "", "", _plane];
		_particle = drop ["\wop_gui\data\cl_basic", "", "Billboard", 1, 25, (_plane selectionposition "osa vrtule 4"), [0,0,0],   	0, 0.0052, 0.0040, 0.1, [1, 15, 30], [[0.5,0.5,0.5,0.0],[0.5,0.5,0.5,0.2],[0.5,0.5,0.5,0.1],[0.5,0.5,0.5,0.05],[0.5,0.5,0.5,0.025],[0.5,0.5,0.5,0.012],[0.5,0.5,0.5,0.0]],[0],0.0,2.0, "", "", _plane];
		_particle = drop ["\wop_gui\data\cl_basic", "", "Billboard", 1, 25, (_plane selectionposition "osa vrtule 5"), [0,0,0],   	0, 0.0052, 0.0040, 0.1, [1, 15, 30], [[0.5,0.5,0.5,0.0],[0.5,0.5,0.5,0.2],[0.5,0.5,0.5,0.1],[0.5,0.5,0.5,0.05],[0.5,0.5,0.5,0.025],[0.5,0.5,0.5,0.012],[0.5,0.5,0.5,0.0]],[0],0.0,2.0, "", "", _plane];
