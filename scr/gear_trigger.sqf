...
while {(alive _an225)} do
{
	if (((_an225 animationPhase "gear_trigger")==1) and ((_an225 animationPhase "gearF")==0)) then
	{
	...
	if (((_an225 animationPhase "gear_trigger")==0) and ((_an225 animationPhase "gearF")==1)) then
	{
		_an225 = _this select 0;
		_an225 say "An225_gear";
